...
def populate_films():
    ...
    daniel_radcliffe = Actor(name='Daniel Radcliffe', birthday=date(1989, 10, 23), is_active=False)
    emma_watson = Actor(name='Emma Watson', birthday=date(1990, 10, 15), is_active=False)
    rupert_grint = Actor(name='Rupert Grint', birthday=date(1988, 9, 24), is_active=False)
    richard_harris = Actor(name='Richard Harris', birthday=date(1930, 10, 1), is_active=False)
    michael_gambon = Actor(name='Michael Gambon', birthday=date(1940, 10, 19), is_active=False)
    alan_rickman = Actor(name='Alan Rickman', birthday=date(1946, 1, 21), is_active=False)
